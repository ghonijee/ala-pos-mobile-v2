...
abstract class _$$_LoadedCopyWith<$Res> {
  ...
  $Res call({dynamic list, bool nextPage});
}
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(this.list, this.nextPage);
  ...
  @override
  String toString() {
    return 'TransactionListState.loaded(list: $list, nextPage: $nextPage)';
  }
