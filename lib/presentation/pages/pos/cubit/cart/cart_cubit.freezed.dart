...
abstract class $CartStateCopyWith<$Res> {
  ...
  $Res call({BuiltList<TransactionItemModel> items});
}
    ...
    return _then(_value.copyWith(
      items: items == freezed
          ...
          : items // ignore: cast_nullable_to_non_nullable
              as BuiltList<TransactionItemModel>,
    ));
  }
}
...
class _$_CartState extends _CartState {
  const _$_CartState({required this.items}) : super._();

  @override
  final BuiltList<TransactionItemModel> items;
...
abstract class _CartState extends CartState {
  const factory _CartState(
      {required final BuiltList<TransactionItemModel> items}) = _$_CartState;
