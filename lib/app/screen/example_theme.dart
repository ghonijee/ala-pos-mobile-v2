...
import 'package:primer_flutter/primer_flutter.dart' as theme;
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final primerTheme = theme.PrimerTheme.of(context);
    return Scaffold(
        ...
        slivers: [
                ...
                [
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        const TextSpan(
                          text: ' to change the font size and weight to match Primer\'s styles.',
                        ),
                      ],
                    ),
                  ),
                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        const TextSpan(text: 'Change the font weight, styles, and alignment with these '),
                        WidgetSpan(
                          child: DecoratedBox(
                            decoration: BoxDecoration(
                              color: primerTheme.neutral.muted,
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate(
                [
                  const Text('You can use the colors below in the following ways:'),
                  const SizedBox(height: 8),
//                   Row(
//                     children: [
//                       SyntaxView(
//                         code: '''/// 1: Via the current `PrimerThemeData` (recommended)
...
class ColorCell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final primerTheme = theme.PrimerTheme.of(context);
    Color labelColor = color.computeLuminance() > 0.5 ? Colors.black : Colors.white;
    return SizedBox(
      height: 70,
      width: 150,
      child: DecoratedBox(
