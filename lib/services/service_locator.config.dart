...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i5.ProductRemoteSource>(
      () => _i5.ProductRemoteSource(get<_i3.ApiClient>()));
  gh.lazySingleton<_i6.ProductRepository>(
      () => _i6.ProductRepository(get<_i5.ProductRemoteSource>()));
  gh.lazySingleton<_i7.StoreRemoteSource>(
      () => _i7.StoreRemoteSource(get<_i3.ApiClient>()));
  gh.lazySingleton<_i8.StoreRepository>(() => _i8.StoreRepository(
      get<_i7.StoreRemoteSource>(), get<_i3.LocalStorage>()));
  gh.lazySingleton<_i9.AuthRepository>(() => _i9.AuthRepository(
      remoteSource: get<_i4.AuthRemoteSource>(),
      storage: get<_i3.LocalStorage>()));
  gh.factory<_i10.ListProductCubit>(() => _i10.ListProductCubit(
      get<_i6.ProductRepository>(), get<_i8.StoreRepository>()));
  gh.factory<_i11.LoginCubit>(() =>
      _i11.LoginCubit(get<_i9.AuthRepository>(), get<_i8.StoreRepository>()));
  gh.factory<_i12.RegisterCubit>(
      () => _i12.RegisterCubit(get<_i9.AuthRepository>()));
  gh.factory<_i13.SideMenuCubit>(
      () => _i13.SideMenuCubit(get<_i9.AuthRepository>()));
  gh.factory<_i14.SplashCubit>(
      () => _i14.SplashCubit(authRepository: get<_i9.AuthRepository>()));
  gh.factory<_i15.StoreFormCubit>(
      () => _i15.StoreFormCubit(get<_i8.StoreRepository>()));
  return get;
}
